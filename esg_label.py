...
SOCIAL_KEYWORDS = [
    "worker safety", "workplace injury", "fatalities", "labor rights", "labour rights",
    "human rights violation", "indigenous communities", "indigenous", "displacement",
    "community opposition", "local communities", "health impacts", "public health",
    "environmental justice", "discrimination", "harassment", "employee welfare",
    "community conflict", "protests", "residents", "livelihoods", "activists",
    "campaigners", "wellbeing", "fishermen", "farmers", "social license",
    "community backlash", "civil society", "NGOs", "opposition",
    "threatened", "harm", "impact", "affected", "local", "community",
    "worker", "employee", "injury", "safety", "rights", "people"
]

GOV_KEYWORDS = [
    "lawsuit", "sued", "litigation", "court ruling", "judgment", "appeal",
    "regulatory violation", "fraud", "bribery", "corruption", "sanctions",
    "investigation", "subpoena", "misleading investors", "accounting irregularities",
    "securities fraud", "financial penalty", "fine", "settlement",
    "lobbying", "internal memo", "misleading statements", "shareholder proposal",
    "activist investor", "board decision", "executive compensation",
    "governance reform", "compliance", "advertising watchdog", "greenwashing",
    "SEC investigation", "attorney general", "probe", "court", "legal",
    "regulatory", "shareholder", "governance", "accountability",
    "internal documents", "contradicted", "spent", "policy", "authority"
]
...
def main():
    ...
    df["is_env"]  = df["env_score"] > 3
    df["is_social"] = df["social_score"] > 3
    df["is_gov"]  = df["gov_score"] > 3
